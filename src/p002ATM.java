 ...
 * <p/>
 * Created on 9/20/13 at 9:27 AM by @author emulcahy
 *
 ...
 * Calculate Pooja's account balance after an attempted transaction.
 ...
 120.00
 */
public class p002ATM {
    public static void main(String[] args) {
        try {
            BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
            String line = br.readLine();
            String[] splitLine = line.split(" ");
            Integer withDrawalAmount = Integer.parseInt(splitLine[0]);
            Float balance = Float.parseFloat(splitLine[1]);
            if (withDrawalAmount % 5 == 0 && balance - withDrawalAmount -.5f > 0) {
                balance -= (withDrawalAmount + .5f);
            }
